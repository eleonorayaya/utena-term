...
final class WindowTabRow: NSView {
    ...
    private static let bgColor = NSColor(white: 0.10, alpha: 1)
    private static let separatorColor = NSColor(white: 0.20, alpha: 1)
    private static let activeTabColor = NSColor(white: 0.18, alpha: 1)
